...
describe('src/test/javascript/component-tests.js', function () {
  ...
  describe('Component: smtpLog', function () {
    ...
    it('should show smtp log event', function () {
      ...
      expect(element[0].querySelector('.intellij-default-todo-text').innerText).toEqual('time1');
      expect(element[0].querySelector('.intellij-default-text').innerText).toEqual('line1');
    });
